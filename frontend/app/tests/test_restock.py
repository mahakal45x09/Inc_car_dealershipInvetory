...
def test_admin_can_restock_vehicle(client: TestClient, setup_data):
    ...
    response = client.post(
        f"/api/vehicles/{v1_id}/restock", json={"quantity": 5}, headers=admin_headers
    )
...
def test_user_cannot_restock(client: TestClient, setup_data):
    ...
    response = client.post(
        f"/api/vehicles/{v1_id}/restock", json={"quantity": 5}, headers=user_headers
    )
...
def test_restock_vehicle_not_found(client: TestClient, setup_data):
    admin_headers = setup_data["admin_headers"]
    response = client.post(
        "/api/vehicles/9999/restock", json={"quantity": 5}, headers=admin_headers
    )
...
def test_restock_zero_quantity(client: TestClient, setup_data):
    ...
    response = client.post(
        f"/api/vehicles/{v1_id}/restock", json={"quantity": 0}, headers=admin_headers
    )
...
def test_restock_negative_quantity(client: TestClient, setup_data):
    ...
    response = client.post(
        f"/api/vehicles/{v1_id}/restock", json={"quantity": -10}, headers=admin_headers
    )
    assert response.status_code == 422
...
def test_large_quantity(client: TestClient, setup_data):
    ...
    response = client.post(
        f"/api/vehicles/{v1_id}/restock", json={"quantity": 1000}, headers=admin_headers
    )
    assert response.status_code == 200
