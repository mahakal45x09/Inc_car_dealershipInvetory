...
async def seed_50_cars():
    ...
    brands = {
        ...
        "Mercedes-Benz": ["G-Class", "S-Class", "AMG GT", "EQS", "C-Class", "GLE", "SL Roadster"],
        "Porsche": ["911 Carrera", "Taycan Turbo S", "Cayenne", "Panamera", "Macan", "911 GT3"],
        "Tesla": ["Model S Plaid", "Model X", "Model 3 Performance", "Cybertruck", "Roadster"],
    ...
    categories = ['Luxury Sedans', 'Sports Cars', 'Electric SUVs', 'SUV', 'Truck', 'Coupe', 'Convertible']
    ...
    for _ in range(50):
        ...
        cat = "Luxury Sedans"
        if "SUV" in model or "X" in model or "Q" in model or "G-Class" in model or "Cruiser" in model or "Defender" in model or "Cayenne" in model:
            cat = "SUV"
        if "M3" in model or "M4" in model or "GT" in model or "911" in model or "Supra" in model or "R8" in model or "LC" in model:
            cat = "Sports Cars"
