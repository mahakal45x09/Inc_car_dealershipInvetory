...
describe('VehicleCard Component', () => {
  ...
  it('renders vehicle details correctly', () => {
    render(
      <MemoryRouter>
        <VehicleCard vehicle={mockVehicle} onPurchase={mockOnPurchase} />
      </MemoryRouter>
    );
  ...
  it('purchase button is disabled and shows Out of Stock when quantity is 0', () => {
    ...
    render(
      <MemoryRouter>
        <VehicleCard vehicle={outOfStockVehicle} onPurchase={mockOnPurchase} />
      </MemoryRouter>
    );
  ...
  it('renders a placeholder image when image_url is missing', () => {
    ...
    render(
      <MemoryRouter>
        <VehicleCard vehicle={noImageVehicle} onPurchase={mockOnPurchase} />
      </MemoryRouter>
    );
